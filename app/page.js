...
// Lazy load the Pricing component since it's below the fold
const Pricing = dynamic(() => import("@/components/pricing"), {
  loading: () => <div className="h-96 animate-pulse bg-muted/30 rounded-lg" />,
...
export default function Home() {
  return (
    <div className="bg-background">{/* Hero Section */}
      ...
      {/* Footer */}
      <footer className="bg-muted/30 border-t border-emerald-800/20 mt-20">
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col items-center text-center">
            <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
              <Link href="/doctors" className="px-4 text-sm text-muted-foreground transition-colors duration-300 hover:text-emerald-400">
                  Find a Doctor
              </Link>
              <Link href="/about" className="mt-2 sm:mt-0 sm:mx-4 px-4 text-sm text-muted-foreground transition-colors duration-300 hover:text-emerald-400">
                  About Us
              </Link>
              <Link href="/contact" className="mt-2 sm:mt-0 px-4 text-sm text-muted-foreground transition-colors duration-300 hover:text-emerald-400">
                  Contact
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            ...
            <div className="flex mt-3 -mx-2 sm:mt-0">
              <a href="#" className="mx-2 text-sm text-muted-foreground transition-colors duration-300 hover:text-emerald-400">
                Privacy Policy
              </a>
              <a href="#" className="mx-2 text-sm text-muted-foreground transition-colors duration-300 hover:text-emerald-400">
                Terms of Service
